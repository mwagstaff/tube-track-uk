...
struct StationArrivalsServiceTests {
    ...
    @Test func beckenhamJunctionResolvesItsDestinationFromTheTimetable() async throws {
        let service = makeService(responses: [
            ...
            "/Line/tram/Timetable/940GZZCRBEK": timetableFixture(destinations: [
        ...
        #expect(
            StationArrivalsURLProtocol.requestCount(
                for: "/Line/tram/Timetable/940GZZCRBEK"
            ) == 1
        )
        #expect(
    ...
    @Test func beckenhamJunctionDoesNotInventADestinationFromAmbiguousPatterns() async throws {
        let service = makeService(responses: [
            ...
            "/Line/tram/Timetable/940GZZCRBEK": timetableFixture(patterns: [
                [(id: "940GZZCRECR", name: "East Croydon Tram Stop")],
                [
    ...
    @Test func millHillEastKeepsUnknownTrainsAlongsideKnownOutboundTrains() async throws {
        let service = makeService(responses: [
            "/StopPoint/940GZZLUMHL/Arrivals": fixture([
                prediction(
                    id: "terminating-bank",
                    line: .northern,
        ...
        #expect(
            StationArrivalsURLProtocol.requestCount(
                for: "/Line/northern/Timetable/940GZZLUMHL"
            ) == 0
        )
    }
    ...
    @Test func allSelfReferentialTubePredictionsDoNotUseAnAmbiguousTimetable() async throws {
        let service = makeService(responses: [
            ...
            "/Line/northern/Timetable/940GZZLUMHL": timetableFixture(patterns: [
    ...
    @Test func bankDLRKeepsOneUnknownTrainAlongsideKnownOutboundTrains() async throws {
        let service = makeService(responses: [
            "/StopPoint/940GZZDLBNK/Arrivals": fixture([
                prediction(
                    id: "terminating",
                    line: .dlr,
        ...
        #expect(
            StationArrivalsURLProtocol.requestCount(
                for: "/Line/dlr/Timetable/940GZZDLBNK"
            ) == 0
        )
    }
    ...
    @Test func highBarnetCollapsesPlatformAlternativesWithoutInventingMorden() async throws {
        ...
        let service = makeService(responses: [
            "/StopPoint/940GZZLUHBT/Arrivals": fixture([
                prediction(
                    id: "known-morden",
                    vehicleID: "072",
                    line: .northern,
        ...
        #expect(
            StationArrivalsURLProtocol.requestCount(
                for: "/Line/northern/Timetable/940GZZLUHBT"
            ) == 0
        )
    }
    ...
    @Test func overgroundTerminusUsesActualDepartureRecords() async throws {
        let service = makeService(responses: [
            "/StopPoint/910GBARKRIV/Arrivals": fixture([
                prediction(
                    id: "incoming",
                    line: .suffragette,
            ...
            "/StopPoint/910GBARKRIV/ArrivalDepartures": fixture([
                [
        ...
        #expect(
            StationArrivalsURLProtocol.queryValues(
                named: "lineIds",
                for: "/StopPoint/910GBARKRIV/ArrivalDepartures"
            ) == ["suffragette"]
        )
        #expect(
            StationArrivalsURLProtocol.requestCount(
                for: "/Line/suffragette/Timetable/910GBARKRIV"
            ) == 0
        )
    }
    ...
    @Test func canaryWharfPreservesDLRDestinationsAndBothJubileeDirections() async throws {
        let service = makeService(responses: [
            "/StopPoint/940GZZDLCAN/Arrivals": fixture([
                prediction(
                    id: "shared-dlr-id",
                    line: .dlr,
            ...
            "/StopPoint/940GZZLUCYF/Arrivals": fixture([
                prediction(
                    id: "jubilee-east-1",
                    line: .jubilee,
            ...
            "/StopPoint/910GCANWHRF/Arrivals": fixture([]),
        ])
    ...
    @Test func mudchutePreservesMultiplePredictionsWithTheSameTfLID() async throws {
        let service = makeService(responses: [
            "/StopPoint/940GZZDLMUD/Arrivals": fixture([
                prediction(
